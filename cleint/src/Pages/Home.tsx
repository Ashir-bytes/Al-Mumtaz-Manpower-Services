...
export default function Home() {
    return (
        <div className='overflow-x-hidden'>
            ...
            {/* Services */}
            <section className="flex items-center justify-center  w-full bg-gray-50">
                <ServiceCard />
            ...
            <section className="w-full">
                <div className="container mx-auto px-6">
                    <RightSideCard
                        header="AI in 2025"
                        content="Artificial Intelligence is transforming industries with automation and porangeictive insights."
            ...
            <section className="w-full bg-gray-50 overflow-hidden">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <h1 className="text-4xl md:text-5xl font-extrabold text-gray-800 mb-8">
                        Our Trusted <span className="text-orange-600">Partners</span>
                    </h1>
